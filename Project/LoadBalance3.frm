...
Begin VB.Form frmLoadBalance3 
   BackColor       =   &H00C0FFFF&
   Caption         =   "Load Balancer 3 (Apparels)"
   ClientHeight    =   7755
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   9285
   ...
   End
End
Attribute VB_Name = "frmLoadBalance3"
...
Private Sub cmdConnect_Click(Index As Integer)
    If Index = 0 Then
        ...
        WinsockServer(0).RemotePort = 10001
    ...
    If Index = 1 Then
        ...
        WinsockServer(1).RemotePort = 10002
    ...
    If Index = 2 Then
        ...
        WinsockServer(2).RemotePort = 10003
