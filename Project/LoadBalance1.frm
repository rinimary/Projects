...
Begin VB.Form frmLoadBalance1 
   BackColor       =   &H00C0C0FF&
   Caption         =   "Load Balancer 1 (Electronics)"
   ClientHeight    =   7755
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   9285
   ...
   End
End
Attribute VB_Name = "frmLoadBalance1"
...
Private Sub cmdConnect_Click(Index As Integer)
    If Index = 0 Then
        ...
        WinsockServer(0).RemotePort = 8001
    ...
    If Index = 1 Then
        ...
        WinsockServer(1).RemotePort = 8002
    ...
    If Index = 2 Then
        ...
        WinsockServer(2).RemotePort = 8003
